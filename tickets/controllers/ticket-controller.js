...
const updateTicket = async(req,res,next) => {
    ...
    try {
        ...
        return next(new HttpError('An error occured while updating the ticket', 500));
    }
    res.status(200).json({message: 'Ticket information successfully updated', ticket: foundTicket.toObject({getters: true})})
